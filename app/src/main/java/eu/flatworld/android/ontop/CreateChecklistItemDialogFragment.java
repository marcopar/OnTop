 ...
 */
public class CreateChecklistItemDialogFragment extends DialogFragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (listener != null) {
                    ...
                    listener.onDismiss(CreateChecklistItemDialogFragment.this, b);
                }
                dismiss();
                return;
            }
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                DialogInteractionInterface listener = (DialogInteractionInterface) getTargetFragment();
                listener.onDismiss(CreateChecklistItemDialogFragment.this, null);
                dismiss();
                return;
            }
        });
